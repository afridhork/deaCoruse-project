...
import CartIcon from '../../assets/cartGray.svg'
import {
  removeItemFromCart,
  selectCartItems,
        ...
        <div className="flex flex-col gap-6 max-h-[500px] overflow-auto">
          {
            products.length > 0 ? (
              ...
              <div className="text-center">
                <h1>You have no product at cart</h1>
              </div>
            )
          }
        </div>
            ...
            products.length > 0 ? (
              ...
              <>
                <div className="flex justify-center">
                  <img src={CartIcon} alt="" className="w-12 h-12" />
                </div>
                <h4 className="text-lg text-center text-gray-300">Empty</h4>
              </>
            )
          }
        </div>
        <div className={`flex items-center ${products.length > 0 ? 'justify-between' : 'justify-end'}`}>
          <button
            type="button"
            className="bg-slate-600 hover:bg-slate-800 text-white py-3 px-8 rounded-xl text-sm mr-0 sm:mr-4"
